Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_evaluate.rb", "test/test_parser.rb", "test/test_pretty_print.rb", "test/test_tokenizer.rb"]
end
